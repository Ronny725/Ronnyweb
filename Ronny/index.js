...
const Vg = () => {
    const [e,t] = L.useState(!1)
      ...
      , [m,d] = L.useState(0)
      , [y,g] = L.useState({
        link: "https://cdn.discordapp.com/attachments/1474912878371930329/1510783342956773426/Senti.png?ex=6a1e1221&is=6a1cc0a1&hm=9e8124b158fe9d8809895fefece6b407defe4e7506df6c3fc519f191ebcdb029&",
        color: "43, 112, 168"
    })
      , [v,P] = L.useState("0vw")
      , [f,c] = L.useState("1.5625vw")
      , [p,w] = L.useState("FLEXBypass")
      , [_,E] = L.useState("0%")
      , [k,O] = L.useState("0%")
      , V = L.useRef([]);
...
const Wg = () => {
  ...
  , Hg = ({notification: e, onRemove: t}) => {
    ...
    , [e.id, e.duration, t]);
    const l = e.type === "success" ? "#23ff2a" : e.type === "error" ? "#ff1100" : "rgb(229, 239, 39)";
    return U("div", {
        ref: n,
        id: `notif-${e.id}`,
        ...
        children: [x("div", {
            ...
            style: {
                backgroundColor: e.type === "success" ? "#23ff2a" : e.type === "error" ? "#ff1100" : "rgb(229, 239, 39)"
            }
        }), x("i", {
